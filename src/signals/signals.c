...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/20 09:21:14 by bhildebr          #+#    #+#             */
/*   Updated: 2024/05/20 09:26:34 by bhildebr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	setup_signal_handler(void (*func)(int signum))
{
	...
	if (sigaction(SIGINT, &sigint_action, NULL) == -1 || sigaction(SIGQUIT, &sigquit_action, NULL) == -1)
